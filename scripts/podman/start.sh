...
##########
echo "starting container '$PREFIX' with options '$OPTIONS'..."

# TODO: it required --network host. Why? What other options work?
podman run --name $PREFIX --network host $OPTIONS $PREFIX

echo "starting container complete."